...
export default function NavLink({ href, children }: NavLinkProps) {
  return (
    <li>
      <a href={href} className="relative px-2 py-1 sm:px-3 sm:py-2 text-sm sm:text-base font-medium text-white/90 hover:text-white transition-all duration-300 group">
